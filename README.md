# Continuous integration och continuous delivery - "Live"-exempel

Detta Git-repo innehåller exempel från terminalen och skriptfiler för varje lektion. Det är en samlad plats för flera versioner av kursen.
